...
exports.isSocket = (socket) =>
{
  ...
  {
    console.log('Socket > undefined JsSIP.Socket instance');
  ...
  try
  {
    ...
    {
      console.log('Socket > missing or invalid JsSIP.Socket url property');
      throw new Error();
    }

    if (!Utils.isString(socket.via_transport))
    {
      console.log('Socket > missing or invalid JsSIP.Socket via_transport property');
      throw new Error();
    }

    if (Grammar.parse(socket.sip_uri, 'SIP_URI') === -1)
    {
      console.log('Socket > missing or invalid JsSIP.Socket sip_uri property');
      throw new Error();
    }
  }
  catch (e)
