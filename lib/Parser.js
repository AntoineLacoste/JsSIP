...
exports.parseMessage = (data, ua) =>
{
  ...
  if (headerEnd === -1)
  {
    console.log('Parser > parseMessage() | no CRLF found, not a SIP message');
  ...
  if (parsed === -1)
  {
    console.log(`Parser > parseMessage() | error parsing first line of SIP message: "${firstLine}"`);
  ...
  */
  while (true)
  {
    ...
    {
      console.log('Parser > parseMessage() | malformed message');
    ...
    if (parsed !== true)
    {
      console.log('Parser > parseMessage() |', parsed.error);
