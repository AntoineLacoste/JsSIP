...
function rfc3261_8_1_3_3()
{
  ...
  {
    console.log('SanityCheck > more than one Via header field present in the response, dropping the response');
...
function rfc3261_18_3_response()
{
  ...
  if (len < contentLength)
  {
    console.log('SanityCheck > message body length is lower than the value in Content-Length header field, dropping the response');
...
function minimumHeaders()
{
  ...
  for (const header of mandatoryHeaders)
  {
    ...
    {
      console.log(`SanityCheck > missing mandatory header field : ${header}, dropping the response`);
