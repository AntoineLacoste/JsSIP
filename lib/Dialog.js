...
module.exports = class Dialog
{
  ...
  constructor(owner, message, type, state = C.STATUS_CONFIRMED)
  {
    ...
    console.log(`Dialog > new ${type} dialog created with status ${this._state === C.STATUS_EARLY ? 'EARLY': 'CONFIRMED'}`);
  }
  ...
  update(message, type)
  {
    ...
    console.log(`Dialog > dialog ${this._id.toString()}  changed to CONFIRMED state`);
  ...
  terminate()
  {
    console.log(`Dialog > dialog ${this._id.toString()} deleted`);
