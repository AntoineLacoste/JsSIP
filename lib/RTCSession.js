...
module.exports = class RTCSession extends EventEmitter
{
  ...
  {
    console.log('RTCSession > connect()');
  ...
  {
    console.log('RTCSession > init_incoming()');
  ...
  answer(options = {})
  {
    ...
    Promise.resolve()
        ...
        else if (mediaConstraints.audio || mediaConstraints.video)
        {
          ...
          return navigator.mediaDevices.getUserMedia(mediaConstraints)
            .catch((error) =>
            {
              ...
              console.log('RTCSession > emit "getusermediafailed" [error:%o]', error);
      ...
      .then(() =>
      {
        ...
        console.log('RTCSession > emit "sdp"');
        this.emit('sdp', e);
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          ...
          .catch((error) =>
          {
            ...
            console.log('RTCSession > emit "peerconnection:setremotedescriptionfailed answer" [error:%o]', error);
  ...
  terminate(options = {})
  {
    console.log('RTCSession > terminate()');
    ...
    switch (this._status)
    {
      ...
      case C.STATUS_INVITE_SENT:
      case C.STATUS_1XX_RECEIVED:
        console.log('RTCSession > canceling session');
      ...
      case C.STATUS_WAITING_FOR_ANSWER:
      case C.STATUS_ANSWERED:
        console.log('RTCSession > rejecting session');
      ...
      case C.STATUS_WAITING_FOR_ACK:
      case C.STATUS_CONFIRMED:
        console.log('RTCSession > terminating session');
  ...
  {
    console.log('RTCSession > sendDTMF() | tones: %s', tones);
    ...
    {
      console.log(`RTCSession > "duration" value is lower than the minimum allowed, setting it to ${RTCSession_DTMF.C.MIN_DURATION} milliseconds`);
      duration = RTCSession_DTMF.C.MIN_DURATION;
    }
    else if (duration > RTCSession_DTMF.C.MAX_DURATION)
    {
      console.log(`RTCSession > "duration" value is greater than the maximum allowed, setting it to ${RTCSession_DTMF.C.MAX_DURATION} milliseconds`);
    ...
    {
      console.log(`RTCSession > "interToneGap" value is lower than the minimum allowed, setting it to ${RTCSession_DTMF.C.MIN_INTER_TONE_GAP} milliseconds`);
  ...
  {
    console.log('RTCSession > sendInfo()');
  ...
  {
    console.log('RTCSession > renegotiate()');
  ...
  {
    console.log('RTCSession > sendRequest()');
  ...
  {
    console.log('RTCSession > receiveRequest()');
          ...
          if (this._late_sdp)
          {
            ...
            this._connectionPromiseQueue = this._connectionPromiseQueue
              ...
              .catch((error) =>
              {
                ...
                console.log('RTCSession > emit "peerconnection: receive request" [error:%o]', error);
                this.emit('peerconnection:setremotedescriptionfailed', error);
              });
          }
          else
  ...
  onTransportError()
  {
    console.log('RTCSession > onTransportError()');
  ...
  onRequestTimeout()
  {
    console.log('RTCSession > onRequestTimeout()');
  ...
  onDialogError()
  {
    console.log('RTCSession > onDialogError()');
  ...
  newDTMF(data)
  {
    console.log('RTCSession > newDTMF()');
  ...
  newInfo(data)
  {
    console.log('RTCSession > newInfo()');
  ...
  _isReadyToReOffer()
  {
    if (! this._rtcReady)
    {
      console.log('RTCSession > _isReadyToReOffer() | internal WebRTC status not ready');
    ...
    if (! this._dialog)
    {
      console.log('RTCSession > _isReadyToReOffer() | session not established yet');
    ...
    {
      console.log('RTCSession > _isReadyToReOffer() | there is another INVITE/UPDATE transaction in progress');
  ...
  _close()
  {
    ...
    if (this._connection)
    {
      ...
      {
        console.log('RTCSession > close() | error closing the RTCPeerConnection: %o', error);
      }
    }
    ...
    {
      console.log('RTCSession > close() | closing local MediaStream');
  ...
  _setACKTimer()
  {
    this._timers.ackTimer = setTimeout(() =>
    {
      if (this._status === C.STATUS_WAITING_FOR_ACK)
      {
        console.log('RTCSession > no ACK received, terminating the session');
  ...
  _createRTCConnection(pcConfig, rtcConstraints)
  {
    ...
    console.log('RTCSession > emit "peerconnection"');
  ...
  {
    console.log('RTCSession > createLocalDescription()');
      ...
      .then(() =>
      {
        if (type === 'offer')
        {
          return connection.createOffer(constraints)
            .catch((error) =>
            {
              console.log('RTCSession > emit "peerconnection:createofferfailed" [error:%o]', error);
        ...
        else
        {
          return connection.createAnswer(constraints)
            .catch((error) =>
            {
              console.log('RTCSession > emit "peerconnection:createanswerfailed" [error:%o]', error);
      ...
      .then((desc) =>
      {
        ...
        return connection.setLocalDescription(desc)
          .catch((error) =>
          {
            ...
            console.log('RTCSession > emit "peerconnection:setlocaldescriptionfailed" [error:%o]', error);
      ...
      .then(() =>
      {
        ...
        return new Promise((resolve) =>
        {
          ...
          const ready = () =>
          {
            ...
            // console.log('RTCSession > emit "sdp"', e);
          ...
          connection.addEventListener('icecandidate', listener = (event) =>
          {
            ...
            if (candidate)
            {
              console.log('RTCSession > emit "icecandidate"');
  ...
  {
    console.log('RTCSession > receiveReinvite()');
    ...
    {
      console.log('RTCSession > invalid Content-Type');
      request.reply(415);
  ...
  {
    console.log('RTCSession > receiveUpdate()');
  ...
  {
    console.log('RTCSession > _processInDialogSdpOffer()');
    ...
    this._connectionPromiseQueue = this._connectionPromiseQueue
      ...
      .then(() =>
      {
        ...
        return this._connection.setRemoteDescription(offer)
          ...
          {
            request.reply(488);
            console.log('RTCSession > emit "peerconnection:setremotedescriptionfailed in dialog sdp" [error:%o]', error);
  ...
  {
    console.log('RTCSession > receiveRefer()');

    if (typeof request.refer_to === undefined)
    {
      console.log('RTCSession > no Refer-To header field present in REFER');
      request.reply(400);
    ...
    {
      console.log('RTCSession > Refer-To header field points to a non-SIP URI scheme');
      request.reply(416);
    ...
    console.log('RTCSession > emit "refer"');
  ...
  {
    console.log('RTCSession > receiveNotify()');
  ...
  {
    console.log('RTCSession > receiveReplaces()');
    ...
    function reject()
    {
      console.log('RTCSession > Replaced INVITE rejected by the user');
      request.reply(486);
    }
  ...
  _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream)
  {
    ...
    Promise.resolve()
      ...
      .then((desc) =>
      {
        ...
        console.log('RTCSession > emit "sending" [request:%o]', this._request);
  ...
  {
    console.log('RTCSession > receiveInviteResponse()');
    ...
    switch (true)
    {
      ...
      case /^1[0-9]{2}$/.test(response.status_code):
      {
        ...
        if (!response.to_tag)
        {
          console.log('RTCSession > 1xx response received without to tag');
          break;
        }
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          ...
          .catch((error) =>
          {
            console.log('RTCSession > emit "peerconnection:setremotedescriptionfailed 1xx invite response" [error:%o]', error);
          ...
          .then(() =>
          {
            this._connection.setRemoteDescription(answer)
              ...
              .catch((error) =>
              {
                ...
                console.log('RTCSession > emit "peerconnection:setremotedescriptionfailed 2xx invite response" [error:%o]', error);
  ...
  {
    console.log('RTCSession > sendReinvite()');
    ...
    this._connectionPromiseQueue = this._connectionPromiseQueue
      ...
      .then((sdp) =>
      {
        ...
        // fix to make work with Asterisk 13
    ...
    function onSucceeded(response)
    {
      ...
      this._connectionPromiseQueue = this._connectionPromiseQueue
        ...
        .catch((error) =>
        {
          ...
          console.log('RTCSession > emit "peerconnection:setremotedescriptionfailed sendReinvite onsucceded" [error:%o]', error);
  ...
  _sendUpdate(options = {})
  {
    console.log('RTCSession > sendUpdate()');
      ...
      if (sdpOffer)
      {
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          ...
          .catch((error) =>
          {
            ...
            console.log('RTCSession > emit "peerconnection:setremotedescriptionfailed sendupdate onsucceeded" [error:%o]', error);
  ...
  {
    console.log('RTCSession > acceptAndTerminate()');
  ...
  _mangleOffer(sdp)
  {
    ...
    if (this._localHold && ! this._remoteHold)
    {
      console.log('RTCSession > mangleOffer() | me on hold, mangling offer');
      for (const m of sdp.media)
      {
        if (holdMediaTypes.indexOf(m.type) === -1)
        {
    ...
    {
      console.log('RTCSession > mangleOffer() | both on hold, mangling offer');
      for (const m of sdp.media)
      {
        if (holdMediaTypes.indexOf(m.type) === -1)
        {
    ...
    {
      console.log('RTCSession > mangleOffer() | remote on hold, mangling offer');
      for (const m of sdp.media)
      {
        if (holdMediaTypes.indexOf(m.type) === -1)
        {
  ...
  _runSessionTimer()
  {
    ...
    if (this._sessionTimers.refresher)
    {
      this._sessionTimers.timer = setTimeout(() =>
      {
        ...
        console.log('----------------------------- rdy to offer fix----------------------------');
        if (!this._isReadyToReOffer()) { return; } // <================== I've added this line
        console.log('RTCSession > runSessionTimer() | sending session refresh request');
    ...
    else
    {
      this._sessionTimers.timer = setTimeout(() =>
      {
        ...
        console.log('RTCSession > runSessionTimer() | timer expired, terminating the session');
  ...
  {
    console.log('RTCSession > newRTCSession()');
  ...
  _connecting(request)
  {
    console.log('RTCSession > session connecting');

    console.log('RTCSession > emit "connecting"');
  ...
  {
    console.log('RTCSession > session progress');

    console.log('RTCSession > emit "progress"');
  ...
  {
    console.log('RTCSession > session accepted');

    this._start_time = new Date();

    console.log('RTCSession > emit "accepted"');
  ...
  {
    console.log('RTCSession > session confirmed');

    this._is_confirmed = true;

    console.log('RTCSession > emit "confirmed"');
  ...
  {
    console.log('RTCSession > session ended');

    this._end_time = new Date();

    this._close();

    console.log('RTCSession > emit "ended"');
  ...
  {
    console.log('RTCSession > session failed');

    this._close();

    console.log('RTCSession > emit "failed"');
  ...
  _onhold(originator)
  {
    console.log('RTCSession > session onhold');

    this._setLocalMediaStatus();

    console.log('RTCSession > emit "hold"');
  ...
  {
    console.log('RTCSession > session onunhold');

    this._setLocalMediaStatus();

    console.log('RTCSession > emit "unhold"');
  ...
  _onmute({ audio, video })
  {
    console.log('RTCSession > session onmute');

    this._setLocalMediaStatus();

    console.log('RTCSession > emit "muted"');
  ...
  {
    console.log('RTCSession > session onunmute');

    this._setLocalMediaStatus();

    console.log('RTCSession > emit "unmuted"');
